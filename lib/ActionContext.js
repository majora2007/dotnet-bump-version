...
class ActionContext {
    ...
    get pusher() {
        ...
        if (this._githubContext.action == "closed") {
            ...
            const mergedBy = (_d = (_c = (_b = (_a = this._githubContext) === null || _a === void 0 ? void 0 : _a.payload) === null || _b === void 0 ? void 0 : _b.pull_request) === null || _c === void 0 ? void 0 : _c.merged_by) === null || _d === void 0 ? void 0 : _d.login;
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access
            const name = mergedBy !== null && mergedBy !== void 0 ? mergedBy : "";
            return {
                name: name,
                email: ""
            };
